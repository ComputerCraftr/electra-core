...
static const unsigned int MAX_ZEROCOIN_TX_SIZE = 350000;
...
bool AcceptBlock(CBlock& block, CValidationState& state, CBlockIndex** ppindex, bool fRequested, CDiskBlockPos* dbp, bool fAlreadyCheckedBlock = false);
